...
const paymentInformationLabels = [
  "Account Name",
  "Type",
  "Bank Name",
  "Bank Account Name",
    ...
    <div>
      ...
      <main>
        ...
        <p className="text-lg tracking-wide text-indigo-800 mt-4">
          Cek kembali data pembelian yang sudah dilakukan
        </p>
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 mt-10 max-w-5xl">
          ...
          <div className="col-span-3 mt-6 flex flex-col items-center md:row-start-3 md:col-start-3">
            <div className="self-start">
              ...
              <label>I have transfered my money </label>
            </div>
            <a className="btn w-full color-block block mt-8 col-span-2">
              Continue
            </a>
          </div>
        </div>
