...
const Navbar = () => {
    ...
    return (
        <div className='grid grid-cols-3 md:flex justify-between fixed z-20 top-0 left-0 right-0 bg-white md:h-20 py-4 px-5 items-center shadow-md'>
            ...
            <BiMenu className='md:hidden h-12 w-12 ml-auto'/>
